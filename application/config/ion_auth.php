 ...
 */
$config['site_title']                 = "EspaceMarquage.fr";       // Site Title, example.com
$config['admin_email']                = "begueytheo@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'Membres';           // Default group, use name
...
$config['max_password_length']        = 200;                  // Maximum Allowed Length of Password
